        ...
        if (result.result.length === 0) {
          ...
          divElement.appendChild(h3Elem);
            ...
            result.result.forEach(customer => { 
              ...
              tdIdElement.textContent = customer.cus_id;
              const tdNameElement = document.createElement("td");
              tdNameElement.textContent = customer.cus_fname;
              const tdDescElement = document.createElement("td");
              tdDescElement.textContent = customer.cus_lname;
              const tdPriceElement = document.createElement("td");
              tdPriceElement.textContent = customer.cus_state;
              // Add elements
